Public Class frmHardLevel
    Dim tries As Integer = 0
    Dim triesLeft As Integer = 15
    Dim guessNums(3) As Integer
    Dim codeNums(3) As Integer
    Dim secondsHard As Integer = 200
    Dim scoreHardSeconds As Integer = 0
    Dim scoreBlackDots As Integer = 0
    Public scoreFinalHard As Integer = 0
    ...
    Private Sub TmrTimeToCompleteHard_Tick(sender As Object, e As EventArgs) Handles tmrTimeToCompleteHard.Tick
        tmrTimeToCompleteHard.Start()
        secondsHard -= 1
        lblTimeLeft.Text = "Time Left: " & secondsHard & "s"

        If secondsHard = 0 Or wonYet = True Or triesLeft = 0 Then

            tmrTimeToCompleteHard.Stop()
            Select Case secondsHard
                Case 160 To 200
                    scoreHardSeconds = 50
                Case 120 To 159
                    scoreHardSeconds = 25
            ...
            scoreFinalHard = scoreHardSeconds + scoreBlackDots
            MessageBox.Show("Your Finished The Level. Let's see how you did!", "Time's Up!", MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
            MessageBox.Show("Your Score for this Level is: " & scoreFinalHard, "Level1 Score", MessageBoxButtons.OK, MessageBoxIcon.Information)
            Me.Hide()
            frmOverV.Show()
        End If
    ...
    Private Sub FrmHardLevel_Load(sender As Object, e As EventArgs) Handles MyBase.Load
